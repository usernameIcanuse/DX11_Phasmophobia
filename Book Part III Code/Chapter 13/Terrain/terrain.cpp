...
bool Terrain::loadTexture(std::string fileName)//if you have a texture file , load the texture file
{
	HRESULT hr = 0;
...
bool Terrain::genTexture(D3DXVECTOR3* directionToLight)//if you don't, create an empty texture file
{
...
float Terrain::getHeight(float x, float z)//camera position x,z
{
