...
HRESULT CTripod::Setup_Component()
{
    ...
    /* For.Com_Model */
    if (FAILED(__super::Add_Component(LEVEL_GAMEPLAY, TEXT("Prototype_Component_Model_Tripod"), TEXT("Com_Model"), (CComponent**)&m_pModelCom)))
        return E_FAIL;
    ...
    if (FAILED(__super::Add_Component(LEVEL_GAMEPLAY, TEXT("Prototype_Component_Collider_OBB"), TEXT("Com_Tripod"), (CComponent**)&m_pTripodCom, &ColliderDesc)))
        return E_FAIL;
