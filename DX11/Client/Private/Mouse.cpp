...
HRESULT CMouse::Setup_Component()
{
    ...
    /* For.Com_Model*/
    if (FAILED(__super::Add_Component(LEVEL_STATIC, TEXT("Prototype_Component_Model_Mouse"), TEXT("Com_Model"), (CComponent**)&m_pModelCom)))
        return E_FAIL;
...
void CMouse::On_Collision_Enter(CCollider* pCollider)
{
}

void CMouse::On_Collision_Stay(CCollider* pCollider)
{
...
void CMouse::On_Collision_Exit(CCollider* pCollider)
{
}
