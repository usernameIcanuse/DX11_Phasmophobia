...
void CCollision_Manager::Initialize()
{
	...
	CheckGroup(COLLISION_TYPE::GHOST, COLLISION_TYPE::DOOR);
	...
	CheckGroup(COLLISION_TYPE::ITEM_AREA, COLLISION_TYPE::GHOST);
	CheckGroup(COLLISION_TYPE::DOTSPROJECTER, COLLISION_TYPE::GHOST);
