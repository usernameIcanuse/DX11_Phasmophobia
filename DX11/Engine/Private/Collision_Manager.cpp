...
void CCollision_Manager::Initialize()
{
	...
	CheckGroup(COLLISION_TYPE::ITEM, COLLISION_TYPE::HOUSE);
	CheckGroup(COLLISION_TYPE::CAMERA, COLLISION_TYPE::HOUSE);
	CheckGroup(COLLISION_TYPE::THERMOMETER, COLLISION_TYPE::HOUSE);
	CheckGroup(COLLISION_TYPE::SPIRITBOX, COLLISION_TYPE::HOUSE);
	CheckGroup(COLLISION_TYPE::TRIPOD, COLLISION_TYPE::HOUSE);

	CheckGroup(COLLISION_TYPE::CAMERA, COLLISION_TYPE::TRUCK);
	...
	CheckGroup(COLLISION_TYPE::SIGHT, COLLISION_TYPE::DOTSPROJECTER);
	CheckGroup(COLLISION_TYPE::SIGHT, COLLISION_TYPE::SPIRITBOX);
	CheckGroup(COLLISION_TYPE::SIGHT, COLLISION_TYPE::OBJECT);
	CheckGroup(COLLISION_TYPE::SIGHT, COLLISION_TYPE::DOOR);
	CheckGroup(COLLISION_TYPE::SIGHT, COLLISION_TYPE::LIGHTSWITCH);
	...
	CheckGroup(COLLISION_TYPE::SPIRITBOX, COLLISION_TYPE::GHOST_AREA);

	CheckGroup(COLLISION_TYPE::GHOST_AREA, COLLISION_TYPE::DOOR);
	CheckGroup(COLLISION_TYPE::GHOST_AREA, COLLISION_TYPE::PLAYER);


	CheckGroup(COLLISION_TYPE::PLAYER, COLLISION_TYPE::DOOR);

	CheckGroup(COLLISION_TYPE::ITEM_AREA, COLLISION_TYPE::PLAYER);
	CheckGroup(COLLISION_TYPE::ITEM_AREA, COLLISION_TYPE::GHOST_AREA);
	CheckGroup(COLLISION_TYPE::DOTSPROJECTER, COLLISION_TYPE::GHOST_AREA);

	CheckGroup(COLLISION_TYPE::PLAYER, COLLISION_TYPE::GHOST_ATTACK);
